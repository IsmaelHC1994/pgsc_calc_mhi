...
class WorkflowPgscCalc {
    ...
    public static void initialise(params, log) {
        if (![params.scorefile, params.scorefile_folder, params.pgs_id, params.trait_efo, params.efo_id, params.pgp_id].any()) {
            Nextflow.error " ERROR: You didn't set any scores to use! Please set --scorefile, --scorefile_folder, --pgs_id, --efo_id, or --pgp_id"
        }
