---
MapOfContent:
  - "[[Bioinformatics MOC#projects]]"
related:
  - "[[ICM - PROJECTS]]"
  - "[[illumina ICA.canvas|illumina ICA]]"
...
- analysis of 55 samples [[#batches for 55 samples (oct 2025)]]
	...
	- [ ] #work  Update REPORT. write how to launch pipeline/use of ICA documentation 
...
- **Coding differences** (main vs alt, workflow, modules): see **mhi-prs readmes** → `mhi-prs/readmes/07-nextflow-adaptations.md` § *Coding differences: main, workflow, and modules (MHI vs non-alt)*.
